...
<head>
    ...
    <title>Ngân Hàng | Shopee Việt Nam</title>
            ...
            <div class="profile-container">
                <div class="profile-sidebar">
                    ...
                    <div class="profile-sidebar-menu" id="sidebarMenu">
                        ...
                        <div class="profile-menu-section">
                            ...
                            <a href="${pageContext.request.contextPath}/user/account/bank" class="profile-menu-item active"><i class="fas fa-university"></i> Ngân Hàng</a>
                ...
                <div class="profile-main">
                    <div class="account-card">
                        <div class="account-card-title">Tài Khoản Ngân Hàng</div>
                        <div class="account-card-subtitle">Quản lý tài khoản ngân hàng để thanh toán nhanh chóng</div>
                        <div class="account-empty">
                            <div class="account-empty-icon"><i class="fas fa-university"></i></div>
                            <div class="account-empty-text">Bạn chưa liên kết tài khoản ngân hàng nào</div>
                            <button class="account-save-btn" style="margin-top:20px;" disabled><i class="fas fa-plus"></i> Thêm Tài Khoản Ngân Hàng</button>
                            <div style="font-size:13px; color:#999; margin-top:8px;">Tính năng sẽ sớm được cập nhật</div>
                        </div>
                    </div>
                </div>
            </div>
