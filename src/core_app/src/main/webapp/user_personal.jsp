...
<head>
    ...
    <title>Thông Tin Cá Nhân | Shopee Việt Nam</title>
            ...
            <div class="profile-container">
                <div class="profile-sidebar">
                    ...
                    <div class="profile-sidebar-menu" id="sidebarMenu">
                        ...
                        <div class="profile-menu-section">
                            ...
                            <a href="${pageContext.request.contextPath}/user/account/personal" class="profile-menu-item active"><i class="fas fa-user-tag"></i> Thông Tin Cá Nhân</a>
                        </div>
                ...
                <div class="profile-main">
                    <div class="account-card">
                        ...
                        <div class="account-card-subtitle">Thông tin tổng hợp về tài khoản của bạn</div>
                        <%
                            String fullName = acc != null && acc.getFullName() != null ? acc.getFullName() : "Chưa cập nhật";
                            String email = acc != null && acc.getEmail() != null ? acc.getEmail() : "Chưa cập nhật";
                            String phone = acc != null && acc.getPhone() != null && !acc.getPhone().isEmpty() ? acc.getPhone() : "Chưa cập nhật";
                            String gender = acc != null && acc.getGender() != null && !acc.getGender().isEmpty() ? acc.getGender() : "Chưa cập nhật";
                            String dob = acc != null && acc.getDateOfBirth() != null && !acc.getDateOfBirth().isEmpty() ? acc.getDateOfBirth() : "Chưa cập nhật";
                            String role = acc != null && acc.getRole() != null ? acc.getRole() : "user";
                        %>
                        <div class="personal-info-row">
                            <div class="personal-info-label">Tên hiển thị</div>
                            <div class="personal-info-value"><%= fullName %></div>
                        </div>
                        <div class="personal-info-row">
                        ...
                        <div class="personal-info-row">
                            <div class="personal-info-label">Số điện thoại</div>
                            <div class="personal-info-value"><%= phone %></div>
                        </div>
                        <div class="personal-info-row">
                            <div class="personal-info-label">Giới tính</div>
                            <div class="personal-info-value"><%= gender %></div>
                        </div>
                        <div class="personal-info-row">
                            <div class="personal-info-label">Ngày sinh</div>
                            <div class="personal-info-value"><%= dob %></div>
                        </div>
                        <div class="personal-info-row">
                            <div class="personal-info-label">Loại tài khoản</div>
                            <div class="personal-info-value"><%= role.substring(0,1).toUpperCase() + role.substring(1).toLowerCase() %></div>
                        </div>
                        <div style="margin-top: 24px;">
                            <a href="${pageContext.request.contextPath}/user/account/profile" class="account-save-btn" style="text-decoration:none; display:inline-block; line-height:40px; text-align:center;">Chỉnh sửa hồ sơ</a>
                        </div>
                    </div>
                </div>
            </div>
