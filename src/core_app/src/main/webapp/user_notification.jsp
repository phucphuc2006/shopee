...
<head>
    ...
    <title>Cài Đặt Thông Báo | Shopee Việt Nam</title>
            ...
            <div class="profile-container">
                <div class="profile-sidebar">
                    ...
                    <div class="profile-sidebar-menu" id="sidebarMenu">
                        ...
                        <div class="profile-menu-section">
                            ...
                            <a href="${pageContext.request.contextPath}/user/account/notification" class="profile-menu-item active"><i class="fas fa-bell"></i> Cài Đặt Thông Báo</a>
                ...
                <div class="profile-main">
                    <div class="account-card">
                        <div class="account-card-title">Cài Đặt Thông Báo</div>
                        <div class="account-card-subtitle">Quản lý cách bạn nhận thông báo từ Shopee</div>
                        <div class="toggle-row">
                            <div class="toggle-info"><div class="toggle-title">Thông báo Email</div><div class="toggle-desc">Nhận thông báo đơn hàng, khuyến mãi qua email</div></div>
                            <label class="toggle-switch"><input type="checkbox" checked><span class="toggle-slider"></span></label>
                        </div>
                        <div class="toggle-row">
                            <div class="toggle-info"><div class="toggle-title">Thông báo SMS</div><div class="toggle-desc">Nhận thông báo đơn hàng, khuyến mãi qua tin nhắn</div></div>
                            <label class="toggle-switch"><input type="checkbox"><span class="toggle-slider"></span></label>
                        </div>
                        <div class="toggle-row">
                            <div class="toggle-info"><div class="toggle-title">Cập nhật đơn hàng</div><div class="toggle-desc">Nhận thông báo khi đơn hàng thay đổi trạng thái</div></div>
                            <label class="toggle-switch"><input type="checkbox" checked><span class="toggle-slider"></span></label>
                        </div>
                        <div class="toggle-row">
                            <div class="toggle-info"><div class="toggle-title">Khuyến mãi & Ưu đãi</div><div class="toggle-desc">Nhận thông tin về Flash Sale, voucher mới</div></div>
                            <label class="toggle-switch"><input type="checkbox" checked><span class="toggle-slider"></span></label>
                        </div>
                        <div class="toggle-row">
                            <div class="toggle-info"><div class="toggle-title">Tin tức Shopee</div><div class="toggle-desc">Nhận bản tin về tính năng mới, sự kiện của Shopee</div></div>
                            <label class="toggle-switch"><input type="checkbox"><span class="toggle-slider"></span></label>
                        </div>
                    </div>
                </div>
